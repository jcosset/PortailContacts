...
function getPoste(id) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            modal.append(modalRowDisplayerFactory({ label: "Téléphone", name: "tel", placeholder: "", value: response.tel}, 'input'))
...
function showPosteModal(id) {
    ...
    Promise.all([ajaxGetPromise("actions.php?type=get&all"), ajaxGetPromise("actions_poste.php?type=get&id=" + id)])
        .then(([entites, poste]) => {
            ...
            modal.append(modalRowDisplayerFactory({ label: "Téléphone", name: "tel", value: poste.tel, iSdisabled: false}, 'input'))
            ...
            modal.append(modalRowDisplayerFactory({ label: "Téléphone Secrétariat", name: "tel_secretariat", value: poste.tel_secretariat, iSdisabled: false }, 'input'))
...
function showContactModal(id) {
    ...
    Promise.all([ajaxGetPromise("actions_poste.php?type=get&all_filtered"), ajaxGetPromise("actions_contact.php?type=get&id=" + id + "&filter=default")])
        .then(([postes, contact]) => {
            ...
            modal.append(modalRowDisplayerFactory({ label: "Poste", name: "poste", optionsHtml }, 'select'))
